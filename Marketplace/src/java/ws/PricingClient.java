 ...
 * @author ttu01
 */
@WebService(serviceName = "PricingService", portName = "PricingPort", endpointInterface = "com.realmarket.ws.pricing.Pricing", targetNamespace = "http://realmarket.com/ws/pricing", wsdlLocation = "WEB-INF/wsdl/Pricing/109.231.124.57_8080/ws/Pricing.wsdl")
public class PricingClient {
    ...
    public com.realmarket.ws.pricing.QueryResponse queryByVersion(java.lang.String serviceIdVersion) {
        ...
        try {
            ...
            Logger.getLogger(PricingClient.class.getName()).log(Level.SEVERE, null, ex);
        }
